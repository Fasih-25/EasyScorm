            ...
            <CCard className="p-4">
                <CCardBody>
                    ...
                    <div className=' d-flex   pe-4 flex-column mb-4'>
                        <p className=''>invite your students to signup using your link</p>
                        <div className='d-flex '>
                            <CInputGroup className="mb-1">
                                <CFormInput type="text" placeholder='hi@regex.global' className='focus-ring focus-ring-light' />
                            </CInputGroup>
                            <Link to="/">
                        ...
                        <div className='d-flex justify-content-end'>
                            <CButton color="Link" className="" onClick={() =>  navigator.clipboard.writeText('hi@regex.global')} style={{fontSize: '12px'}}>
                    ...
                    <div className='d-flex mb-3 w-25 align-items-center'>
                        ...
                        <CFormSelect aria-label="Default select example" className='mx-2 ' style={{width: 'fit-content'}}>
                    ...
                    <div className='overflow-x-auto' style={{overflow: 'auto'}}>
                        ...
                        <CTableBody>
                            <CTableRow >
                                ...
                                <CTableDataCell>  
                                    <Link to="/Home">
                                        <CButton color="" className="border border-1 border-dark px-4 mx-1 mb-1 mb-md-0" style={{fontSize: '12px', width: '80px'}}>
                                            Ban
                                        </CButton>
                                    </Link>
                                    <Link to="/">
                                        <CButton color="" className="border border-1 border-dark px-3 mx-1 "  style={{fontSize: '12px', width: '80px'}}>
                                            Delete
                                        </CButton>
                                    </Link>
                                </CTableDataCell>
                        ...
                        <div className='d-flex justify-content-end'>
                            <CButton color="dark" variant="outline" className='mx-1'>previous</CButton>
                            <CButton color="primary" className=" " style={{fontSize: '12px'}}>
                                1
                            </CButton>
                            <CButton color="dark" variant="outline" className='mx-1'>Next</CButton>
                        </div>
